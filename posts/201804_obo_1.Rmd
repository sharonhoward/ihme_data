...
## If *datalicenceurl* is present it specifies a licence for the *data* that differs from my usual CC-BY-SA licence; there should be further information in the text body. 
...
## Don't forget you can search in the Console for documentation for R packages and functions by typing the name of the package/function preceded by ? 
...
obo <- read_csv("../data/obo_trials_20180402.csv", na="NULL" )
