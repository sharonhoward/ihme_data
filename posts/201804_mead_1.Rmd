...
datalicenceurl: creativecommons.org/licenses/by/4.0/
---
...
## This RMarkdown file has been used to generate visualisations and HTML posted at mindseye.sharonhoward.org

## In order to reproduce the output you'll need, in addition to this file:
## * R and RStudio installed on your computer (https://www.rstudio.com/)
## * the R packages listed in the #load packages# section below
## * the data file(s) in the #get data# section

## Ensure that the data file is in the right location relative to this file
## If you've downloaded and unzipped or cloned the repository from github, everything should already be in the right place, with the file/folder structure like this:

## ihme-master/
## ├─ data/   [data files folder]
## ├─ posts/  [code files folder]
## ├─ readme.md

## A note on the YAML metadata block at the top of this file ##

## This is primarily for any RStudio users who want to convert the Rmarkdown to HTML
## in the output: options I specify a custom template, CSS and included files: these will cause RStudio's Knit function to fail!
## So if you want to be able to Knit the file, you *must* delete the following lines:
...
## and it's probably a good idea to delete these as well:
##     theme: null
##     self_contained: false [ymmv]

## More on the YAML:

## *ihmefilename* has been added for my own use. You can ignore it or delete it if you want.

## If *datalicenceurl* is present it specifies a licence for the *data* that differs from the usual CC-BY-SA licence; there should be further information in the text body. 

## Whatever the status of the data, this Rmarkdown file is licensed under a [Creative Commons Attribution 4.0 licence (CC BY-SA)](http://creativecommons.org/licenses/by/4.0/). 
...
## Don't forget you can search in the Console for documentation for R packages and functions by typing the name of the package/function preceded by ? (eg ?mutate)
...
map <- read_tsv("../data/mead_apprentices_philadelphia_201804.tsv" )
...
moc <- read_csv("../data/mead_occupational_codes_201804.csv")
